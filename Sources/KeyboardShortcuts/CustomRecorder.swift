//
//  CustomRecorder.swift
//  Settings
//
//  Created by Jackson Utsch on 12/21/21.
//
...
extension KeyboardShortcuts {
	...
	public struct CustomRecorder: NSViewRepresentable {
		let name: Name
		var onChange: ((_ shortcut: Shortcut?) -> Void)? = nil
		...
		public func makeNSView(context: Context) -> CustomCocoaRecorder {
			return .init(for: name, onChange: onChange)
		}

		public func updateNSView(_ nsView: CustomCocoaRecorder, context: Context) {
			nsView.shortcutName = name
		}
	}

	public final class CustomCocoaRecorder: NSSearchField, NSSearchFieldDelegate {
		private let minimumWidth: Double = 70
